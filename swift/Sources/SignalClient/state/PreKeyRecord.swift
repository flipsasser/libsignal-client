...
public class PreKeyRecord: ClonableHandleOwner {
    ...
    public init(id: UInt32,
        ...
        assertNoError(signal_pre_key_record_new(&handle, id, publicKey.nativeHandle, privateKey.nativeHandle))
        super.init(owned: handle!)
    }

    public convenience init(id: UInt32, privateKey: PrivateKey) {
        self.init(id: id, publicKey: privateKey.publicKey, privateKey: privateKey)
    }
